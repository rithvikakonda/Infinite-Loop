    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4 flex justify-center items-start">
      <div className="container max-w-4xl space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">🎙️ Speech-to-Speech Translation</h1>
          <p className="text-gray-600">Translate speech from one language to another with your chosen voice</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 space-y-6">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all ${
                  isRecording ? 'bg-red-500 hover:bg-red-600 text-white animate-pulse' : 'bg-blue-500 hover:bg-blue-600 text-white'
                }`}
              >
            ...
            {recordedAudioUrl && (
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-700 font-medium">Recorded Audio</span>
                  <button onClick={clearAudio} className="text-red-500 hover:text-red-700">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                <audio controls src={recordedAudioUrl} className="w-full" />
          ...
          <button
            onClick={translateSpeech}
            disabled={!audioFile || loading}
            className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-semibold text-lg hover:from-blue-600 hover:to-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Translating...</> : 'Translate Speech'}
          </button>
